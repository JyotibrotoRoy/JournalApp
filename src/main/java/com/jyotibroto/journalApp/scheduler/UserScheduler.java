package com.jyotibroto.journalApp.scheduler;
...
import com.jyotibroto.journalApp.enums.Sentiment;
...
public class UserScheduler {
    ...
    public void fetchUserAndSendSaMail() {
        ...
        for(User user: users) {
            ...
            List<Sentiment> sentiments = journalEntries.stream().filter(x -> x.getDate().isAfter(LocalDateTime.now().minus(7, ChronoUnit.DAYS))).map(JournalEntry::getSentiment).toList();
